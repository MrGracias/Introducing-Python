...
def removeLastItemInList(L):
    '''
    (list) --> list
    return same list with last item removed
    removeLastItemInList([1, 2, 3, 4]) -->
    [1, 2, 3]    
    '''
    del L[-1]
    return L
...
if __name__ == '__main__':
     ...
     # Added this later using the for loop for placing items separated by commas
     print()
     print('****************** Added later ******************')
     print() 
     print('\n\nPrinting with comma separators #1')
     print(extinct_birds[0], end='')
     for bird in range(1, len(extinct_birds)):
         print(', ', extinct_birds[bird], end = '')
     print("\nEnd of list")



     print('\n\nPrinting with comma separators #2')
     for bird in range(len(extinct_birds) - 1):
         print(extinct_birds[bird], ', ',  end = '')
     print(extinct_birds[-1])


     # Change an individual value of the list
     print('\n\n')
     print('original extinct_birds:', extinct_birds)

     for sophia in range(len(extinct_birds)):
         if extinct_birds[sophia] == 'dodo':
             extinct_birds[sophia] = 'tutu'
     print('changed extinct_birds:', extinct_birds)
     ...
     myListToTestFx = ['Joe', 'Mary', 'Jose']
     print(removeLastItemInList(myListToTestFx))
